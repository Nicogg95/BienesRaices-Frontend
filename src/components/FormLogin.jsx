...
const FormLogin = () => {
    ...
    const {iniciarSesion, error} = useAgentes()
    ...
    const handleSubmit = async (e) =>{
        ...
        setAlerta({msg:error, error: true})
        ...
        <div className={`flex flex-col justify-center items-center  col-span-2 md:col-span-1 -translate-x-[0rem]`}>
            ...
            <div className="w-full mt-5">
                <form action="" onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="my-10 flex flex-col-reverse md:flex-row  justify-center gap-y-5 gap-x-20">
