...
const FormLoginRegistro = () => {
    ...
    const ubicacion = "-top-[50px] left-[18rem] md:left-[28rem] sm:left-[32rem] lg:left-[23rem]";
        ...
        <div className={`flex flex-col justify-center items-center col-span-2 md:col-span-1 md:col-start-2`}>
            ...
            <form action="" className="w-full" onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="h-[21rem] overflow-auto px-5">
                    ...
                    <Ping ubicacion={"-top-[50px] left-[16rem] md:left-[12rem] sm:left-[30rem] lg:left-[22rem]"} input={fechaNacimiento} />
                ...
                <div className="flex flex-col md:flex-row my-10 justify-center gap-6">
                    <div {...getRootProps()} className="border p-4 h-fit bg-yellow-600 font-bold">
                        <input type="file" name="foto" {...getInputProps()}/>
                        <div className="flex justify-center gap-x-3 items-center">
                            <p className="cursor-pointer uppercase">Foto de perfil</p>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.5v6m3-3H9m4.06-7.19-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                            </svg>
                        </div> 
                    </div>
                    <div className="border flex items-center md:w-52 p-4 gap-x-3 justify-center bg-slate-800 md:h-fit">
