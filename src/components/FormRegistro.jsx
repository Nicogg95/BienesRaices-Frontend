...
const FormLoginRegistro = () => {
    ...
    const ubicacion = "inset-y-14 right-8";
        ...
        <div className={`flex flex-col justify-center items-center col-span-2 md:col-span-1 md:col-start-2`}>
            ...
            <div className="w-full">
                <form action="" onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="h-[21rem] overflow-scroll px-5">
                        ...
                        <div className="relative">
                            ...
                            <Ping ubicacion={"inset-y-14 right-11"} input={fechaNacimiento} />
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row my-10 justify-center gap-6">
                        <div {...getRootProps()} className="border p-4 md:h-fit bg-yellow-600 font-bold">
                        ...
                        <div className="border flex items-center md:w-52 p-4 gap-x-3 justify-center bg-slate-800">
