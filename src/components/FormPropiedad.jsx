    ...
    <>
      <div className="my-5">
        ...
        <form action="" onSubmit={handleSubmit} className="md:w-10/12 mx-auto px-5" encType="multipart/form-data">
          ...
          <div className="flex justify-center items-center mx-auto gap-x-5 my-10 md:w-10/12">
            <div {...getRootProps()} className="border p-3 md:w-8/12 bg-yellow-600 font-bold">
            ...
            <div className="border flex items-center gap-x-3 p-6 justify-center bg-slate-800 md:w-40">
