  ...
  return (
    <>
        <form action="" onSubmit={handleSubmit} className="md:w-11/12 mx-auto" encType="multipart/form-data">
            <Campo texto={"Titulo:"} funcion={e=>setTitulo(e.target.value)} 
                nombre={"titulo"} valor={titulo}/>
            ...
            <div className="flex md:flex-row justify-center gap-x-5 my-10">
                <div {...getRootProps()} className="bg-yellow-600 uppercase font-bold p-5 border w-fit ">
                    <input type="file" name="imagenBlog" id="imagenBlog" {...getInputProps()}/>
                ...
                <div className="border flex items-center gap-x-3 p-5 justify-center bg-slate-800">
                    <button type="button" className="uppercase font-semibold cursor-pointer" onClick={()=>limpiarForm()}>Limpiar
                    </button>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
