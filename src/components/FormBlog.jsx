    ...
    <>
        <div className="container">
            <form action="" onSubmit={handleSubmit} className="md:w-11/12 mx-auto" encType="multipart/form-data">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center mx-auto gap-5 my-10 w-full md:w-10/12">
                    <div {...getRootProps()} className="border p-4 bg-yellow-600 font-bold w-full">
